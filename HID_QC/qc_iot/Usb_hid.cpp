...
char hidTable[59][2] = {
  { 30, '1' }, { 31, '2' }, { 32, '3' }, { 33, '4' }, { 34, '5' }, { 35, '6' }, { 36, '7' }, { 37, '8' }, { 38, '9' }, { 39, '0' }, { 86, '-' }, { 87, '+' }, { 89, '1' }, { 90, '2' }, { 91, '3' }, { 92, '4' }, { 93, '5' }, { 94, '6' }, { 95, '7' }, { 96, '8' }, { 97, '9' }, { 98, '0' }, { 99, '.' }, { 4, 'A' }, { 5, 'B' }, { 6, 'C' }, { 7, 'D' }, { 8, 'E' }, { 9, 'F' }, { 10, 'G' }, { 11, 'H' }, { 12, 'I' }, { 13, 'J' }, { 14, 'K' }, { 15, 'L' }, { 16, 'M' }, { 17, 'N' }, { 18, 'O' }, { 19, 'P' }, { 20, 'Q' }, { 21, 'R' }, { 22, 'S' }, { 23, 'T' }, { 24, 'U' }, { 25, 'V' }, { 26, 'W' }, { 27, 'X' }, { 28, 'Y' }, { 29, 'Z' }
};
char data_list[20];
char *rcv_msg;
int feedback_msg = 0;
